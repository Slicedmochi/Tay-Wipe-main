...
*/
		...
		Construct_Header(msg as text, big as num)
			set category = "Admin"
	...
	verb/Archive_Jutsu(obj/jutsu/J in world)
		set category = "Admin"
		if(istype(J, /perk_box))
			var/perk_box/perk_box = J
			J = perk_box:reference
	...
	verb/Archive_Weapon(obj/items/Weapon/J in world)
		set category = "Admin"
