...
client
	authenticate = 0
world
	hub="AxiomStudios.Tiria"
	hub_password = "avainerWINS"
	view = 20
	name = "TAY WIPE"
	status = "TAY WIPE"
	tick_lag=0.5
...
proc/WorldAutoSave()
	while(1)
		sleep(18000)
		world<<"Make sure you are in the discord! [archive.discordinvite]!"
		sleep(18000)
		SaveAll()
