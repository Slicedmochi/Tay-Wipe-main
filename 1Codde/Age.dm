...
mob
	verb
		GM_Help()
			...
			if(alert("This will send an alert to all GMs. If you use this verb without a valid reason, Shinobi Saga's staff may punish you. Are you sure you want to alert the staff?","Alert","Yes","No")=="Yes")
