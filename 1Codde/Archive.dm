...
/archive
	...
	var/list/fake_keys = list("Sevil", "DevilReaper", "twitch.tv/savi0rtv", "Seeker3", "Kizutsukeru", "Novalbi", "Seteden5", "MikaNX", "Fenoopy")
