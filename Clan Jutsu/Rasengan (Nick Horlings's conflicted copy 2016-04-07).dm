	...
	Click()
		if(src in usr.contents)
			if(!usr.Convert)
				...
				usr.Chakra-=10
				src.Active=1
				usr<<output("<font size = -3>You have activated Suimen Hokou no Waza, you have control and balanced chakra to your feet and can now walk on water, climb mountains, and climb trees.","ICout")

				usr<<output("<font size = -3>You have activated Suimen Hokou no Waza, you have control and balanced chakra to your feet and can now walk on water, climb mountains, and climb trees.","ICOOCout")
				usr.Convert=1
				usr.overlays -= 'Swim.dmi'
				usr.swim=0
			else
				usr<<output("<font size = -3>You have deactivated Suimen Hokou no Waza.","ICout")
				usr<<output("<font size = -3>You have deactivated Suimen Hokou no Waza.","ICOOCout")
				usr.Convert=0
				src.Active=0
